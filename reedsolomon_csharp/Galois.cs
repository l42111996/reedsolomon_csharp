...
namespace fec
{
     ...
     */
        ...
        public static readonly short[] LOG_TABLE = new short[]
        {
        ...
        public static readonly sbyte[] EXP_TABLE = new sbyte[]
        {
        ...
        {
            byte[] result = new byte[EXP_TABLE.Length];
            for (var i = 0; i < EXP_TABLE.Length; i++)
            {
                result[i] = (byte) EXP_TABLE[i];
            }
            return result;
        }
